                                        ...
                                        <div className="row g-4">
                                            ...
                                            {productList.map((product, index) => {
                                                return <div className="col-md-6 col-lg-4 col-xl-3" key={index}>
                                                    <div className="rounded position-relative fruite-item" style={{ height: '300px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                                                        <div className="fruite-img">
                                                            <img src={product.thumbnail} className="img-fluid w-50 rounded-top" alt="" style={{backgroundColor:"white"}}/>
                                                        </div>
                                                        <div className="p-4 border border-secondary border-top-0 rounded-bottom">
                                                            <h3 style={{ fontSize: "20px" }}>{product.title}</h3>
                                                            <div className="d-flex justify-content-between flex-lg-wrap">
                                                                <p className="text-dark fs-5 fw-bold mb-0" style={{ marginLeft: "60px" }}>  {Number(product.price).toFixed(2)} Rs.</p>
                                                                <a onClick={() => navigate(`/view-more/${product._id}`)} className="btn border border-secondary rounded-pill pb-4 text-primary text-center" style={{ marginLeft: "40px", height: "30px", marginTop: "10px" }}><i className="fa fa-eye me-2 text-primary" style={{ paddingBottom: "12px" }}></i> View More</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
